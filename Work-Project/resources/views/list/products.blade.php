<!-- resources/views/list/products.blade.php -->
        ...
        <div class="content">
            ...
            <ul class="styled-list">
                @foreach($products as $product)
                    <li><b>{{ $product->cod }}</b>  <b>-</b>  <b>{{ $product->name }}</b>  <b>-</b>  {{ $product->description }}  <b>-</b>  {{ $product->price }}  <b>-</b>  {{ $product->vendor_name }}  <b>-</b>  {{ $product->vendor_email }}</li>
                @endforeach
            </ul>
        </div>
    </body>
