<!-- resources/views/list/linorders.blade.php -->
        ...
        <div class="content">
            ...
            <ul class="styled-list">
                @foreach($linorders as $linorder)
                    <li><b>{{ $linorder->id }}</b>  <b>-</b>  {{ $linorder->product_code }}  <b>-</b>  {{ $linorder->product_name }}  <b>-</b>  {{ $linorder->product_description }}  <b>-</b>  {{ $linorder->product_price }}</li>
                @endforeach
            </ul>
        </div>
    </body>
