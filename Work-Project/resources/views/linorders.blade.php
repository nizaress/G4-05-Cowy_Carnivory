...
<html lang="en">
    ...
    <body>
        ...
        <div style="display: flex; justify-content: space-between; margin-top: 1%; margin-bottom: 1%; margin-left: 6%;margin-right: 6%;">
            <form class="frm" action="{{ url('/linorder/delete') }}" method="POST" style="display: flex; align-items: center; margin-left: 0%;">
                @csrf
            ...
            <div style="display: flex; align-items: center; margin-right: 6%; margin-left: 2%; flex-wrap: nowrap;">
                ...
                <form class="frm" action="{{ url('/linorder') }}" method="GET" style="margin-left: 0; margin-right: 4%;">
